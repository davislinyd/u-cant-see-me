...
The popup and Options page ship in English and Traditional Chinese (Taiwan). A language segmented control on both surfaces persists the choice in synced settings and re-renders immediately; product terms such as Gmail, Strict Mask, Blur, Mosaic, URL, and locator stay in English in both languages. The language preference travels with configuration import/export.
